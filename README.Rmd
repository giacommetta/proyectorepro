...
Launch the [`make.R`](https://github.com/giacommetta/proyectorepro/tree/main/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/giacommetta/proyectorepro/blob/main/CONTRIBUTING.md).
